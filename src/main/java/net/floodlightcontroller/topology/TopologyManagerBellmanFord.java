...
public class TopologyManagerBellmanFord implements IFloodlightModule,
		ITopologyService, IRoutingService, ILinkDiscoveryListener,
		IOFMessageListener {

	protected static Logger log = LoggerFactory
			.getLogger(TopologyManagerBellmanFord.class);
	...
	protected TopologyInstanceBellmanFord currentInstance;
	protected TopologyInstanceBellmanFord currentInstanceWithoutTunnels;
	 ...
	 * Debug Counters
	 */
	protected static final String PACKAGE = TopologyManagerBellmanFord.class.getPackage()
			.getName();
	...
	/**
	 * Set the time interval for the period topology updates, if any. The time
	 * is in milliseconds.
	 * 
	 * @return
	 */
	...
	public boolean isAttachmentPointPort(long switchid, short port,
		...
		TopologyInstanceBellmanFord ti = getCurrentInstance(tunnelEnabled);
	...
	private class HAListenerDelegate implements IHAListener {
		...
		@Override
		public String getName() {
			return TopologyManagerBellmanFord.this.getName();
		}
	...
	protected void registerTopologyDebugEvents()
		...
		try {
			evTopology = debugEvents.registerEvent(PACKAGE, "topologyevent",
					"Topology Computation", EventType.ALWAYS_LOG,
	...
	protected Set<Short> getPortsToEliminateForBDDP(long sid) {
		Set<NodePortTuple> suppressedNptList = linkDiscovery
	...
	protected void doFloodBDDP(long pinSwitch, OFPacketIn pi,
		...
		TopologyInstanceBellmanFord ti = getCurrentInstance(false);
	...
	protected boolean createNewInstance(String reason) {
		...
		TopologyInstanceBellmanFord nt = new TopologyInstanceBellmanFord(
				switchPorts, blockedPorts, openflowLinks, broadcastDomainPorts,
				tunnelPorts);
		nt.compute();
	...
	/**
	 * We expect every switch port to have at most two links. Both these links
	 * must be unidirectional links connecting to the same switch port. If not,
	 * we will mark this as a broadcast domain port.
	 */
	...
	public TopologyInstanceBellmanFord getCurrentInstance(boolean tunnelEnabled) {
		if (tunnelEnabled)
	...
	public TopologyInstanceBellmanFord getCurrentInstance() {
